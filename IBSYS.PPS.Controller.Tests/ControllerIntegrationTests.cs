...
namespace IBSYS.PPS.Controller.Tests
{
    ...
    {
        protected DbContextOptions<IbsysDatabaseContext> ContextOptions { get;  }
        protected ControllerIntegrationTests(DbContextOptions<IbsysDatabaseContext> contextOptions)
        {
        ...
        private void Seed()
        {
            using (var context = new IbsysDatabaseContext(ContextOptions))
            {
                ...
                context.AddRange(laborAndMachineCosts);
                context.AddRange(initialStockEParts);
                context.AddRange(initialStockKParts);
                context.SaveChanges();
            }
        }
    }
